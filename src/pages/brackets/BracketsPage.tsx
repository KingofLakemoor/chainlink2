              ...
              {bracket?.cost !== undefined && (
                <div className="bg-zinc-800/50 p-4 border-b border-zinc-800 flex justify-between items-center px-6">
                  ...
                  <div className="text-2xl font-black text-white flex items-center gap-2">
                    ...
                    {Math.floor((bracket.totalPot || 0) * (bracket.prizePotPercent !== undefined ? bracket.prizePotPercent : 0.60))} <span className="text-sm font-medium text-zinc-500">Links</span>
                  </div>
                </div>
              )}
              {leaderboardLoading ? (
