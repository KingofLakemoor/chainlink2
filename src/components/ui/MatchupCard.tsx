      ...
      const content = (
          <>
              {featuredSponsorObj?.image && (
                  <FirebaseImage src={featuredSponsorObj.image} alt={featuredName} className="h-5 w-5 rounded object-contain" />
              )}
        ...
        <div className="flex items-center justify-between">
           <div className="flex flex-col items-center gap-2 sm:gap-3 w-[100px] sm:w-[140px]">
             ...
             <div className="relative">
               ...
               >
                  <FirebaseImage src={m.type === 'OVER_UNDER' ? '/images/over.png' : m.awayTeam.image} className="w-full h-full object-contain drop-shadow-md" alt={m.type === 'OVER_UNDER' ? 'OVER' : m.awayTeam.name} />
               </button>
           ...
           <div className="flex flex-col items-center gap-2 sm:gap-3 w-[100px] sm:w-[140px]">
             ...
             <div className="relative">
               ...
               >
                  <FirebaseImage src={m.type === 'OVER_UNDER' ? '/images/under.png' : m.homeTeam.image} className="w-full h-full object-contain drop-shadow-md" alt={m.type === 'OVER_UNDER' ? 'UNDER' : m.homeTeam.name} />
               </button>
