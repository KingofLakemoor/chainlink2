          ...
          <div className="p-5 flex flex-col items-center text-center">
            ...
            <div className="flex items-center justify-center gap-8 w-full">
              <div className={cn("flex flex-col items-center gap-3 p-4 rounded-xl border relative", activePick?.pick?.id === (activeMatchup.type === 'OVER_UNDER' ? 'OVER' : activeMatchup.awayTeam.id) ? 'border-green-500 bg-green-500/10' : 'border-zinc-800 opacity-50')}>
                <FirebaseImage src={activeMatchup.type === 'OVER_UNDER' ? '/images/over.png' : activeMatchup.awayTeam.image} fallback={activeMatchup.league === 'SCRIPTLESS' ? '/assets/scriptless-small.png' : "/logo.png"} className="w-16 h-16 object-contain" alt={activeMatchup.type === 'OVER_UNDER' ? 'OVER' : activeMatchup.awayTeam.name} loading="lazy" />
              ...
              <div className={cn("flex flex-col items-center gap-3 p-4 rounded-xl border relative", activePick?.pick?.id === (activeMatchup.type === 'OVER_UNDER' ? 'UNDER' : activeMatchup.homeTeam.id) ? 'border-green-500 bg-green-500/10' : 'border-zinc-800 opacity-50')}>
                <FirebaseImage src={activeMatchup.type === 'OVER_UNDER' ? '/images/under.png' : activeMatchup.homeTeam.image} fallback={activeMatchup.league === 'SCRIPTLESS' ? '/assets/scriptless-small.png' : "/logo.png"} className="w-16 h-16 object-contain" alt={activeMatchup.type === 'OVER_UNDER' ? 'UNDER' : activeMatchup.homeTeam.name} loading="lazy" />
