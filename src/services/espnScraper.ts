export type League = "NFL" | "NBA" | "NHL" | "MLB" | "MLS" | "EPL" | "MBB" | "WBB" | "NWSL" | "COLLEGE-FOOTBALL" | "WNBA" | "PGA" | "FIFA" | "ATP" | "WTA" | string;
...
export async function fetchScheduleData(endpoint: string, league: League, isScoreboardOnly: boolean = false) {
  ...
  if (league === "MBB" || league === "WBB" || league === "PGA" || league === "ATP" || league === "WTA" || isScoreboardOnly) {
